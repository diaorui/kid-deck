...
"}\n"
            ...
            "          if (oldRow) { oldRow.className = 'track-item upcoming'; oldRow.querySelector('.track-indicator').innerHTML = ''; }\n"
            "          var newRow = currentIdx >= 0 && currentIdx < trackList.children.length ? trackList.children[currentIdx] : null;\n"
            "          if (newRow) { newRow.className = 'track-item current'; newRow.querySelector('.track-indicator').innerHTML = '\\u25B6'; }\n"
            "        } else {\n"
            "          apTrackFp = fp;\n"
